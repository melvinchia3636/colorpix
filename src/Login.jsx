...
function Login({ isLoginOpen }) {
  ...
  return (
    <div className={`absolute top-0 w-full h-screen transition-all duration-700 bg-zinc-800 flex ${isLoginOpen ? "left-0" : "-left-full"}`}>
      <div className="w-1/2 p-16 pl-32 flex items-center justify-center">
        <div>
          <h2 className="text-4xl font-medium tracking-widest text-white">
            Welcome Back
          </h2>
          <p className="mt-2 text-zinc-500 tracking-wide">Sign in save and publish your Colorpix art work online.</p>
          <div className="w-full group relative flex items-center mt-16 border-2 border-zinc-500 focus-within:border-zinc-200 group rounded-md transition-all">
            ...
            <input className="w-full border-0 p-6 bg-transparent text-white placeholder-zinc-500 tracking-wide focus:outline-none caret-zinc-200" type="text" placeholder="example@mail.com" />
          ...
          <div className="w-full group relative flex items-center mt-11 border-2 border-zinc-500 focus-within:border-zinc-200 group rounded-md transition-all">
            ...
            <input className="w-full border-0 p-6 bg-transparent text-white placeholder-zinc-500 tracking-wide focus:outline-none caret-zinc-200" type="text" placeholder="•••••••••" />
            <Icon icon="mdi:lock" className="w-6 h-6 mr-6 text-zinc-500 group-focus-within:text-white transition-all" />
          </div>
          <button className="mt-12 w-full bg-zinc-200 text-lg font-medium tracking-wide py-3 rounded-md hover:bg-zinc-300 text-zinc-800 focus:outline-none transition-all">
            Sign In
          </button>
          ...
          <div className="text-zinc-500 text-center text-sm mt-4">
            Don&apos;t have an account? <a className="text-zinc-200 hover:text-zinc-300 transition-all font-medium" href="#">Sign up</a>
          </div>
        </div>
      </div>
      <div className="relative w-1/2 bg-zinc-600">
        ...
        <div className="w-full h-full absolute top-0 left-0 flex flex-col items-center justify-center">
          {showWord && (
            <>
              ...
              <p className="text-white mt-2 text-xl animate__animated animate__fadeInDown">Create your unique piece of artwork</p>
            </>
          )}
        </div>
      </div>
