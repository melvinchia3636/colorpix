  ...
  return (
    <div>
      ...
      <p className="mt-2 text-zinc-500 tracking-wide w-[28rem]">
        Create an account save and publish your Colorpix art work online.
      </p>
      <div className="w-full group relative flex items-center mt-16 border-2 border-zinc-500 focus-within:border-zinc-200 group rounded-md transition-all">
        <input
          ...
          className="w-full border-0 p-6 bg-transparent text-white placeholder-zinc-500 tracking-wide focus:outline-none caret-zinc-200 invalid:text-rose-500 invalid:placeholder-rose-500 peer"
          type="email"
          placeholder="example@mail.com"
        />
        <div className="absolute top-0 left-3 bg-zinc-800 -translate-y-1/2 px-3 text-zinc-500 group-focus-within:text-zinc-200 transition-all peer-invalid:text-red-500">
          Email
        </div>
        <Icon
          icon="mdi:at"
          className="w-6 h-6 mr-6 text-zinc-500 group-focus-within:text-white transition-all peer-invalid:text-rose-500"
        />
      </div>
